    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <header class="bg-white shadow">
            <div class="px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <h1 class="ml-2 md:ml-0 text-xl font-bold text-gray-900">Gestion des Réservations</h1>
                </div>
                <div class="flex items-center">
        ...
        <main class="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8 bg-gray-50">
            <div class="mb-8">
                ...
                <p class="text-gray-600">Gérez les réservations de votre entreprise</p>
            </div>
                            ...
                            <div class="px-4 py-4 sm:px-6">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4">
                                            <p class="text-sm font-medium text-pink-600">Réservation #123</p>
                                            <p class="text-sm text-gray-500">Client: Marie Dupont</p>
                                        </div>
                                    </div>
                                    <div class="flex items-center">
