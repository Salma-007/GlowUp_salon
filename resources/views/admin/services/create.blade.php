...
<div class="bg-white shadow-lg rounded-lg p-6 max-w-2xl mx-auto">
    ...
    <form action="{{ route('services.store') }}" method="POST">
        ...
        <div class="mb-6">
            ...
            <input type="text" id="name" name="name" placeholder="Entrez le nom du service" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-300">
        </div>

        <!-- Description du service -->
        <div class="mb-6">
            <label for="description" class="block text-sm font-medium text-gray-700 mb-2">Description du service</label>
            <textarea id="description" name="description" rows="4" placeholder="Entrez la description du service" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-300"></textarea>
        </div>
        ...
        <div class="mb-6">
            ...
            <input type="number" id="price" name="price" placeholder="Entrez le prix du service" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-300">
        </div>

        <!-- Durée du service -->
        <div class="mb-6">
            <label for="service-duration" class="block text-sm font-medium text-gray-700 mb-2">Durée (minutes)</label>
            <input type="number" id="duration" name="duration" placeholder="Entrez la durée du service" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-300">
        </div>
